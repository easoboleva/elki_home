...
const product = {
  ...
  images: [
    {
      src: 'https:/elkihome.ru/img/bergamo/1-min.png',
      alt: 'Заснеженная ель bergamo',
    },
    {
      src: 'https:/elkihome.ru/img/bergamo/2-min.png',
      alt: 'Заснеженная ель bergamo',
    },
    {
      src: 'https:/elkihome.ru/img/bergamo/3-min.png',
      alt: 'Заснеженная ель bergamo',
    },
    {
      src: 'https:/elkihome.ru/img/bergamo/4-min.png',
      alt: 'Искусственная заснеженная елка bergamo',
    },
  ],

  description: 'Искусственная заснеженная елка Bergamo - премиальная новогодняя ель, имеющая пышный силуэт и натуральный вид приснеженной хвои, словно усыпана настоящим снегом в лесу. Ель экологичная и изготовлена из пожаробезопасных материалов, снег представляет собой искусственный хлопок (флок), нанесенный на производстве, не имеет запаха и не осыпается.',
  highlights: [
        ...
        <div className="mx-auto max-w-2xl px-4 pt-10 pb-16 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pt-16 lg:pb-24">
          ...
          <div className="mt-4 lg:row-span-3 lg:mt-0">
            ...
            <p className="text-xl tracking-tight text-gray-900">
              <li>150 см - 13 900 руб.</li>
              <li>180 см - 18 900 руб.</li>
              <li>210 см - 26 900 руб.</li>
              <li>240 см - 36 900 руб.</li>
            </p>
