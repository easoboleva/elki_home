...
const product = {
  ...
  images: [
    {
      src: 'https://elkihome.ru/img/saintpaul/4-min-min.png',
      alt: 'Заснеженная ель Saint Paul',
    },
    {
      src: 'https://elkihome.ru/img/saintpaul/2-min-min.png',
      alt: 'Заснеженная ель Saint Paul',
    },
    {
      src: 'https://elkihome.ru/img/saintpaul/3-min-min.png',
      alt: 'Заснеженная ель Saint Paul',
    },
    {
      src: 'https://elkihome.ru/img/saintpaul/1-min-min.png',
      alt: 'Искусственная заснеженная елка',
    },
  ],

  description:
    'Искусственная заснеженная елка Saint Paul - премиальная новогодняя ель, имеющая натуральный вид приснеженной хвои, словно усыпана настоящим снегом в лесу. Ветви елки направлены вверх, как у настоящей ели или пихты. Ель экологичная и изготовлена из пожаробезопасных материалов, снег представляет собой искусственный хлопок (флок), нанесенный на производстве, не имеет запаха и не осыпается.',
  highlights: [
