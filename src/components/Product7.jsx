...
const product = {
  name: 'Искусственная заснеженная елка Adele',
  price: '15900р.',
  href: '/product7',
  breadcrumbs: [
  ...
  images: [
    {
      src: 'https://elkihome.ru/img/adele/1-min.png',
      alt: 'Заснеженная ель adele',
    },
    {
      src: 'https://elkihome.ru/img/adele/2-min.png',
      alt: 'Заснеженная ель adele',
    },
    {
      src: 'https://elkihome.ru/img/adele/3-min.png',
      alt: 'Заснеженная ель adele',
    },
    {
      src: 'https://elkihome.ru/img/adele/4-min.png',
      alt: 'Искусственная заснеженная елка adele',
    },
  ],

  description: 'Искусственная заснеженная елка Adele - премиальная новогодняя ель, имеющая дикий силуэт, как у пихты Фразера, и натуральный вид приснеженной хвои, словно усыпана настоящим снегом в лесу. Ветви елки направлены вверх, как у настоящей ели или пихты. Ель экологичная и изготовлена из пожаробезопасных материалов, снег представляет собой искусственный хлопок (флок), нанесенный на производстве, не имеет запаха и не осыпается.',
  highlights: [
        ...
        <div className="mx-auto max-w-2xl px-4 pt-10 pb-16 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pt-16 lg:pb-24">
          ...
          <div className="mt-4 lg:row-span-3 lg:mt-0">
            ...
            <p className="text-xl tracking-tight text-gray-900">
              <li>150 см - 11 900 руб.</li>
              <li>150 см - 16 900 руб.</li>
              <li>210 см - 24 900 руб.</li>
              <li>240 см - 33 900 руб.</li>
            </p>
