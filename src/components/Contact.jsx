const features = [
  { name: 'Телефон', description: '+7 (991) 735-65-33' },
  ...
  return (
    <div >
      <div className="grid items-center max-w-3xl grid-cols-1 px-4 py-0 mx-auto gap-y-8 gap-x-8 sm:px-4 sm:py-2 lg:max-w-4xl lg:grid-cols-2 lg:px-4">
        ...
        <div className="grid items-center max-w-xl px-4 py-16 mx-auto gap-y-2 gap-x-2 sm:px-6 sm:py-8 lg:max-w-7xl lg:grid-cols-1 lg:px-8">
        <h3 className="mt-3">Шоу-рум в Москве</h3>
          <iframe className="py-2" src="https://yandex.ru/map-widget/v1/?um=constructor%3A4d002b0fb2edd274adce9bdff120a838777d0c9d6bc116df4cff7401dd9c6efc&amp;source=constructor" width="250" height="250"></iframe>
        <h3>Шоу-рум в Санкт-Петербурге</h3>
          <iframe className="py-2" src="https://yandex.ru/map-widget/v1/?um=constructor%3Aedd67efa3e2159c630342d9f638f0f20018eadd04adaa75dc9251ce4417d7f55&amp;source=constructor" width="250" height="250"></iframe>
        </div>
      </div>
    </div>
  )
