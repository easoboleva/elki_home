...
const product = {
  ...
  images: [
    {
      src: 'https://elkihome.ru/img/bourget/2-min.png',
      alt: 'Заснеженная ель Bourget',
    },
    {
      src: 'https://elkihome.ru/img/bourget/3-min.png',
      alt: 'Заснеженная ель Bourget',
    },
    {
      src: 'https://elkihome.ru/img/bourget/22-min.png',
      alt: 'Заснеженная ель Bourget',
    },
    {
      src: 'https://elkihome.ru/img/bourget/1-min.png',
      alt: 'Искусственная заснеженная елка Bourget',
    },
  ],

  description:
    'Искусственная заснеженная елка Bourget - премиальная новогодняя ель, имеющая стройный силуэт правильной формы и натуральный вид приснеженной хвои, словно усыпана настоящим снегом в лесу. Ель экологичная и изготовлена из пожаробезопасных материалов, снег представляет собой искусственный хлопок (флок), нанесенный на производстве, не имеет запаха и не осыпается.',
  highlights: [
        ...
        <div className="mx-auto max-w-2xl px-4 pt-10 pb-16 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pt-16 lg:pb-24">
          ...
          <div className="mt-4 lg:row-span-3 lg:mt-0">
            ...
            <p className="text-xl tracking-tight text-gray-900">
              <li>180 см - 12 900 руб.</li>
              <li>210 см - 17 900 руб.</li>
