...
const product = {
  name: 'Искусственная заснеженная елка Geneva',
  price: '15900р.',
  href: '/product4',
  breadcrumbs: [
  ...
  images: [
    {
      src: 'https://elkihome.ru/img/geneva/DSC_0730 _1_.jpg',
      alt: 'Заснеженная ель Geneva',
    },
    {
      src: 'https://elkihome.ru/img/geneva/DSC_0741 _1_.jpg',
      alt: 'Заснеженная ель Geneva',
    },
    {
      src: 'https://elkihome.ru/img/geneva/DSC_0746 _1_.jpg',
      alt: 'Заснеженная ель Geneva',
    },
    {
      src: 'https://elkihome.ru/img/geneva/DSC_0739 _1_.jpg',
      alt: 'Искусственная заснеженная елка Geneva',
    },
  ],

  description:
    'Искусственная заснеженная елка Geneva - премиальная новогодняя ель, имеющая изящный силуэт, мелкую, похожую на натуральную, иглу и приснеженную хвою, словно усыпана настоящим снегом в лесу. Ель экологичная и изготовлена из пожаробезопасных материалов, снег представляет собой искусственный хлопок (флок), нанесенный на производстве, не имеет запаха и не осыпается.',
  highlights: [
        ...
        <div className="mx-auto max-w-2xl px-4 pt-10 pb-16 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pt-16 lg:pb-24">
          ...
          <div className="mt-4 lg:row-span-3 lg:mt-0">
            ...
            <p className="text-xl tracking-tight text-gray-900">
              <li>150 см - 14 900 руб.</li>
              <li>180 см - 23 900 руб.</li>
              <li>210 см - 32 900 руб.</li>
              <li>240 см - 42 900 руб.</li>
            </p>
